...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20240124214632_mig_11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.FileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Idetity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Idetity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.InvoiceFile", b =>
                {
                    b.HasBaseType("ETicaretAPI.Domain.Entites.FileEntity");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entites.Basket", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Idetity.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Idetity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entites.Idetity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
